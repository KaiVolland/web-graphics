...
import { Vector, Vector1, Vector2, Vector3, Vector4 } from './Vector';
...
describe('Vector1', () => {
  ...
  it('should calculate the dot product of two Vector1 instances', () => {
    ...
    expect(Vector.dot(vector1, vector2)).toBe(6);
  });
  ...
  it('should subtract two Vector1 instances', () => {
    const vector1 = new Vector1([5]);
    const vector2 = new Vector1([2]);
    const result = Vector.substract(vector1, vector2);
...
describe('Vector2', () => {
  ...
  it('should calculate the dot product of two Vector2 instances', () => {
    ...
    expect(Vector.dot(vector1, vector2)).toBe(23);
  });
  ...
  it('should subtract two Vector2 instances', () => {
    const vector1 = new Vector2([5, 7]);
    const vector2 = new Vector2([2, 3]);
    const result = Vector.substract(vector1, vector2);
    expect(result.values).toEqual([3, 4]);
  });
});
...
describe('Vector3', () => {
  ...
  it('should calculate the dot product of two Vector3 instances', () => {
    ...
    expect(Vector.dot(vector1, vector2)).toBe(56);
  });
  ...
  it('should subtract two Vector3 instances', () => {
    const vector1 = new Vector3([5, 7, 9]);
...
describe('Vector4', () => {
  ...
  it('should calculate the dot product of two Vector4 instances', () => {
    ...
    expect(Vector.dot(vector1, vector2)).toBe(110);
  });
  ...
  it('should subtract two Vector4 instances', () => {
    const vector1 = new Vector4([5, 7, 9, 11]);
    const vector2 = new Vector4([2, 3, 4, 5]);
    const result = Vector.substract(vector1, vector2);
    expect(result.values).toEqual([3, 4, 5, 6]);
  });
});
